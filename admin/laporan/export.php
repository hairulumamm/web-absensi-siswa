...
if ($format === 'excel') {
    ...
    $spreadsheet->getProperties()
        ->setCreator('SMKN 40 Absensi System')
        ->setLastModifiedBy('SMKN 40 Admin')
        ->setTitle($title)
        ->setSubject('Attendance Report')
        ->setDescription('Attendance report generated by SMKN 40 Absensi System');
    ...
    $sheet->setCellValue('A2', 'SMKN 40 JAKARTA');
    ...
    $logoPath = $_SERVER['DOCUMENT_ROOT'] . '/e:/Faiz Sekolah/OOP/Web-Absensi/assets/default/logo-smk40.png';
