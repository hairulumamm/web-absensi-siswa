...
<head>
    ...
    <title>Login Admin - Sekolah Pondok Pesantren Al-Hanifiyyah</title>
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center bg-[url('../assets/default/bg-pattern.png')] bg-repeat">
    ...
    <div class="max-w-md w-full mx-4 relative z-10">
        ...
        <div class="text-center mb-8">
            <img src="../assets/default/logo_pesantren.jpg" alt="SMKN 40"
            ...
            <p class="text-gray-400">Sistem Absensi Sekolah Pondok Pesantren Al-Hanifiyyah</p>
        </div>
